...
exports.up = db => {
  return db.query(`CREATE TABLE field (
    ...
    requiredErrorMessage VARCHAR(120),
    forTableFieldId INT NULL,
    ...
    INDEX field_tableId_fk_idx (forTableFieldId ASC),
    ...
    CONSTRAINT field_category_fk
      ...
      ON DELETE RESTRICT
      ON UPDATE NO ACTION,
    CONSTRAINT field_tableId_fk
      FOREIGN KEY (forTableFieldId)
      REFERENCES field (id)
      ON DELETE RESTRICT
      ON UPDATE NO ACTION
  )`);
